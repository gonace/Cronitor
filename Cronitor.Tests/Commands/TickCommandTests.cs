...
namespace Cronitor.Tests.Commands
{
    public class TickCommandTests
    {
        ...
        public void ShouldCreateTickCommandWithExtendedProperties()
        {
            ...
            Assert.Equal("tick", command.ToString());
            Assert.Equal(HttpMethod.Get, command.Method);
            Assert.Equal("https://cronitor.link/p/apiKey/monitorKey/tick?host=127.0.0.1&message=Lorem ipsum dolor sit amet%2C consectetur adipiscing elit.&env=Production&series=3de5db91-9c02-4e95-b8a9-9a2442702336&metric=count%3A9.99", command.ToUrl());
        }
    }
}
